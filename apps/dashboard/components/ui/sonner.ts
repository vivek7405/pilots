...
import { onBeforeCache } from '../../lib/utils/dom.ts';
...
// Tokens, not raw swatches. The kit ships emerald / sky / amber here, which
// this app forbids: a raw colour is the same in both themes and answers to no
// palette change. --success, --warning and --info are defined in app/layout.ts
// beside every other colour and mapped in public/input.css.
