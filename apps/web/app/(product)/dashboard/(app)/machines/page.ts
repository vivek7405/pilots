/**
 * `/dashboard/machines` is now `/dashboard/sandboxes`.
 *
 ...
 *
 * `/dashboard/machines/<id>` and its terminal keep their paths. A URL segment is an
...
export default function MachinesRedirect(): never {
  throw redirect('/dashboard/sandboxes', 308);
}
