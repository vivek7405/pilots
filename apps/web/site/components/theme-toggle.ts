...
import { THEME_STORAGE_KEY, readTheme, type Theme } from '#site/lib/theme.ts';

/**
 * `<site-theme-toggle>`: cycles system → light → dark → system.
 *
...
ThemeToggle.register('site-theme-toggle');
