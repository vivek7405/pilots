...
| `sdks/js/`, `sdks/go/`, `sdks/python/`, `sdks/elixir/` | `@pilots/sdk` (npm), `github.com/pilotsrun/pilots/sdks/go`, `pilots-sdk` (PyPI) and `pilots` (Hex). Each has a drift test against hostd's own source |
